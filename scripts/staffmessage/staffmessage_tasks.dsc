staffmessage_send_staff_to_player:
    debug: false
    type: task
    ...
    - define player_message "<&7>Staff -<&gt> You<&f>: <[message]>"
    - define staff_message "<&7>You -<&gt> <[target_name]><&f>: <[message]>"
...
staffmessage_reply_player_to_staff:
    debug: false
    type: task
    definitions: player|staff|message
    script:
    - define message <[message].replace[&\].with[&].unescaped>
    - define player_message "<&7>You -<&gt> Staff<&f>: <[message]>"
    - define staff_message "<&7><[player].name> -<&gt> You<&f>: <[message]>"
