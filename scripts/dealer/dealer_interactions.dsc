...
dealer_interact_dropbox_task:
    ...
    - give <proc[itemdb_get].context[hammer]> quantity:5
    - give <proc[itemdb_get].context[baseball bat]> quantity:6
    - give <proc[itemdb_get].context[metal bat]> quantity:4
    - give <proc[itemdb_get].context[hunting knife]> quantity:3
    - give <proc[itemdb_get].context[mechete]> quantity:2
    - give <proc[itemdb_get].context[spiked baseball bat]> quantity:1
    - give <proc[itemdb_get].context[katana]> quantity:1
    - give <proc[itemdb_get].context[sledgehammer]> quantity:1
    - give <proc[itemdb_get].context[riot helmet]> quantity:3
