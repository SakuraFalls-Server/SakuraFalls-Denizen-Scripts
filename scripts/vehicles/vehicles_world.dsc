...
vehicle_world_parallel_loop:
    ...
    - if <[vehicle].flag[vehicles_data].get[driver_entity].has_passenger>:
        - foreach <[vehicle].location.find_players_within[15]> as:listener:
            ...
            - playsound <[new_location]> <[listener]> custom sound:<[sound]> pitch:<element[0.9].add[<[speed].abs.mul[32].mod[24].round_down.div[36]>]> volume:<proc[settings_get].context[<[listener]>|sound_vehicles_volume].div[200]>
